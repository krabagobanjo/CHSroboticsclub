...
task main() {
  ...
  while(true){
    ...
    nxtDisplayCenteredBigTextLine(1, "SPOOL");
    ...
    if(nNxtButtonPressed == 1) {spoolDirection=1;}
    if(nNxtButtonPressed == 2) {spoolDirection=-1;}

    switch(spoolDirection){
      case -1:
       motor[spoolR]=-50;
      break;
      case 1:
